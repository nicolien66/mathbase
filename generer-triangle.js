...
const M_TYPES = [
  ...
  function (d) {
    ...
    return {
      /* On NE décrit PAS le codage : le lire est précisément l'exercice.
         La correction n'en souffre pas, car la solution officielle énonce la
         nature attendue et le raisonnement. */
