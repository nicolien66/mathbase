/* MathBase — patch-contenu-volume.js
   Renomme le chapitre « Probabilités » en « Volumes » dans
...
const NOUVEAU = iN >= 0 && ARGS[iN + 1] ? ARGS[iN + 1] : "Bases des probabilités";
const ANCIEN = "Probabilités";
...
fs.writeFileSync(`${cible}.avant-probas-${stamp}`, avant, "utf8");
fs.writeFileSync(cible, src, "utf8");
console.log(`\nSauvegarde : ${path.basename(cible)}.avant-probas-${stamp}`);
console.log(`${cible} mis à jour.`);
console.log(`\nLancez ensuite generer-probabilites.js pour la partie base de données.`);
