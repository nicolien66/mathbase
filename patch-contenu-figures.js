/* MathBase — patch-contenu-figures.js
   Renomme le chapitre « Les parallélogrammes » en « Figures » dans
   ...
   Options :
     ...
     --nom "Polygones"               pour un autre intitulé (défaut « Figures »)
*/
...
const NOUVEAU = iN >= 0 && ARGS[iN + 1] ? ARGS[iN + 1] : "Figures";
const ANCIEN = "Les parallélogrammes";
...
fs.writeFileSync(`${cible}.avant-figures-${stamp}`, avant, "utf8");
fs.writeFileSync(cible, src, "utf8");
console.log(`\nSauvegarde : ${path.basename(cible)}.avant-figures-${stamp}`);
console.log(`${cible} mis à jour.`);
console.log(`\nLancez ensuite generer-figures.js pour la partie base de données.`);
